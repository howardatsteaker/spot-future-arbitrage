...
def save_merged_trades(
    ...
    start_ts: int,
    end_ts: int,
    save_path: str = "local/merged_trades",
):
...
if __name__ == "__main__":
    ...
    save_kline_from_trades(
        spot_data_dir, spot, start, end, resolution="1H", save_dir="local/kline"
    )
    save_kline_from_trades(
        future_data_dir, future, start, end, resolution="1H", save_dir="local/kline"
    )
    save_merged_trades(
        future,
        future_data_dir,
